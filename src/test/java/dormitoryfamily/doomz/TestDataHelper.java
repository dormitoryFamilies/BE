...
public class TestDataHelper {
    ...
    public static Map<String, Member> createDummyMembers() {
        return Map.ofEntries(
                entry("홍길동", createMember(1L, "홍길동(진리관)", "공대여신", "hong1@example.com", "1234567890", CollegeType.ENGINEERING, DepartmentType.KOREAN_LITERATURE, MemberDormitoryType.JINRIGWAN, LocalDate.of(1990, 2, 11), GenderType.MALE, "https://s3.amazonaws.com/yourbucket/profile1.jpg", "https://s3.amazonaws.com/yourbucket/student1.jpg", 12, 4, true)),
                entry("김영희", createMember(2L, "김영희(정의관)", "철학소녀", "kim2@example.com", "0987654321", CollegeType.HUMANITIES, DepartmentType.PHILOSOPHY, MemberDormitoryType.JEONGUIGWAN, LocalDate.of(1992, 5, 18), GenderType.FEMALE, "https://s3.amazonaws.com/yourbucket/profile2.jpg", "https://s3.amazonaws.com/yourbucket/student2.jpg", 34, 7, true)),
                entry("이철수", createMember(3L, "이철수(개척관)", "자연남자", "lee3@example.com", "1122334455", CollegeType.NATURAL_SCIENCES, DepartmentType.HISTORY, MemberDormitoryType.GAECHEOKGWAN, LocalDate.of(1995, 3, 12), GenderType.MALE, "https://s3.amazonaws.com/yourbucket/profile3.jpg", "https://s3.amazonaws.com/yourbucket/student3.jpg", 23, 12, true)),
                entry("박민수", createMember(4L, "박민수(계영원)", "사회과학자", "park4@example.com", "2233445566", CollegeType.SOCIAL_SCIENCES, DepartmentType.GERMAN_LANGUAGE_CULTURE, MemberDormitoryType.GYEYOUNGWON, LocalDate.of(1988, 8, 30), GenderType.MALE, "https://s3.amazonaws.com/yourbucket/profile4.jpg", "https://s3.amazonaws.com/yourbucket/student4.jpg", 56, 22, false)),
    ...
    public static List<Lifestyle> createDummyLifestyles(Map<String, Member> members) {
        return Arrays.asList(
                ...
                createLifestyle(members.get("박민수"), SleepTimeType.BEFORE_2100, WakeUpTimeType.BEFORE_0600, SleepingHabitType.SLEEP_TALKING, SleepingSensitivityType.LIGHT, SmokingType.SMOKER, DrinkingFrequencyType.NONE, null, ShowerDurationType._10, CleaningFrequencyType.IMMEDIATELY, HeatToleranceType.HIGH, ColdToleranceType.HIGH, MBTIType.ESTJ, null, LateNightSnackType.SOMETIMES, SnackInRoomType.ALLOWED, PhoneSoundType.VARIABLE, PerfumeUsageType.OFTEN, null, ExamPreparationType.PREPARING, ExerciseType.NONE, InsectToleranceType.EXPERT, "술 먹고 춤 춤"),
