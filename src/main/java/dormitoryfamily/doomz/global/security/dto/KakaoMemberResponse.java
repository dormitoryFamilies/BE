...
public class KakaoMemberResponse {
    ...
    public String getName() {
        ...
        return properties.get("name").toString(); // 진짜 이름으로 수정해야 함
    }
    ...
    public LocalDate getBirthDate() {
        int birthYear = Integer.parseInt(attributes.get("birthyear").toString());
        String birthDate = attributes.get("birthday").toString();
