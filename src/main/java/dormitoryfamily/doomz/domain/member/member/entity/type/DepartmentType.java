...
import dormitoryfamily.doomz.domain.member.member.exception.InvalidDepartmentTypeException;
import dormitoryfamily.doomz.domain.member.member.exception.MismatchedCollegeException;
